...
public class FtcTest extends AltRyanFtcTeleOp implements FtcMenu.MenuButtons, FtcGamepad.ButtonHandler
{
...
//    }   //stopMode
    ...
    public void runContinuous(double elapsedTime)
    {
        ...
        switch (test)
        {
            ...
            case GYRO_TURN:
                ...
                //robot.encoderYPidCtrl.setPID(pidp, 0.0, pidd, 0.0);
    ...
    private void doMenus()
    {
        ...
        FtcValueMenu pid_p = new FtcValueMenu(
                "P value:", testMenu, this, 0, 1, 0.005, pidp, " %.3f");
        FtcValueMenu pid_d = new FtcValueMenu(
                "D value:", testMenu, this, 0, 1, 0.005, pidd, " %.3f");
...
//        testMenu.addChoice("PID P", Test.PID_P, pid_p);
//        testMenu.addChoice("PID D", Test.PID_D, pid_d);
        //
        // Traverse menus.
        //
        ...
        pidp = pid_p.getCurrentValue();
        pidd = pid_d.getCurrentValue();
